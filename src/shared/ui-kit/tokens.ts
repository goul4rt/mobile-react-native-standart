/**
 * Tokens de `docs/design/design.md`. Nomenclatura semântica: o componente pede
 * `color.primary`, o tema resolve. Verde e vermelho são reservados pra
 * acerto/erro — nunca decoração.
 */
...
const dark: typeof light = {
  ...
  // Botão primário no escuro: texto escuro sobre o roxo claro (contraste 8,6:1).
  onPrimary: '#1B1B22',
  success: '#3DD68C',
...
/**
 * Sempre o PostScript name, nunca `fontWeight`: os SemiBold registram família
 * própria ("Lexend SemiBold"), então pedir peso 600 na família base cai no
 * Regular no iOS e no bold sintético no Android.
 */
export const type = {
  ...
  /** A métrica mais importante do app: o enunciado. */
...
/** Base 4. Margem lateral 24, padding de cartão 16, respiro entre seções 40. */
export const space = { xs: 4, sm: 8, md: 12, lg: 16, xl: 20, xxl: 24, section: 40 } as const;

export const radius = { sm: 8, md: 12, lg: 16, xl: 20, pill: 999 } as const;

/** Sem sombras (Android de entrada): profundidade por borda + superfície. */
